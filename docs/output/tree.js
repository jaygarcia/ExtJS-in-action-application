		...
		Docs.classData ={"id":"apidocs","iconCls":"icon-docs","text":"API Documentation","singleClickExpand":true,"children":[
                {"id":"pkg-CompanyMgr","text":"CompanyMgr","iconCls":"icon-pkg","cls":"package","singleClickExpand":true, children:[
                {"href":"output/CompanyMgr.CompanySnapshot.html","text":"CompanySnapshot","id":"CompanyMgr.CompanySnapshot","isClass":true,"iconCls":"icon-cmp","cls":"cls","leaf":true}
				,
                {"href":"output/CompanyMgr.DepartmentMgr.html","text":"DepartmentMgr","id":"CompanyMgr.DepartmentMgr","isClass":true,"iconCls":"icon-cmp","cls":"cls","leaf":true}
				,
                {"href":"output/CompanyMgr.EmployeeEditorWindow.html","text":"EmployeeEditorWindow","id":"CompanyMgr.EmployeeEditorWindow","isClass":true,"iconCls":"icon-cmp","cls":"cls","leaf":true}
				,
                {"href":"output/CompanyMgr.EmployeeMgr.html","text":"EmployeeMgr","id":"CompanyMgr.EmployeeMgr","isClass":true,"iconCls":"icon-cmp","cls":"cls","leaf":true}
				,
                {"href":"output/CompanyMgr.workspace.html","text":"workspace","id":"CompanyMgr.workspace","isClass":true,"iconCls":"icon-static","cls":"cls","leaf":true}
				]}
				,
				...
				,
                {"id":"pkg-TKE","text":"TKE","iconCls":"icon-pkg","cls":"package","singleClickExpand":true, children:[
                {"id":"pkg-TKE.chartpanel","text":"chartpanel","iconCls":"icon-pkg","cls":"package","singleClickExpand":true, children:[
                {"href":"output/TKE.chartpanel.ChartPanelBaseCls.html","text":"ChartPanelBaseCls","id":"TKE.chartpanel.ChartPanelBaseCls","isClass":true,"iconCls":"icon-cmp","cls":"cls","leaf":true}
				,
                {"href":"output/TKE.chartpanel.DeptBreakdown.html","text":"DeptBreakdown","id":"TKE.chartpanel.DeptBreakdown","isClass":true,"iconCls":"icon-cmp","cls":"cls","leaf":true}
				,
                {"href":"output/TKE.chartpanel.TotalCompany.html","text":"TotalCompany","id":"TKE.chartpanel.TotalCompany","isClass":true,"iconCls":"icon-cmp","cls":"cls","leaf":true}
				]}
				,
                {"id":"pkg-TKE.form","text":"form","iconCls":"icon-pkg","cls":"package","singleClickExpand":true, children:[
                {"href":"output/TKE.form.DepartmentMgrForm.html","text":"DepartmentMgrForm","id":"TKE.form.DepartmentMgrForm","isClass":true,"iconCls":"icon-cmp","cls":"cls","leaf":true}
				,
                {"href":"output/TKE.form.EmployeeMgrForm.html","text":"EmployeeForm","id":"TKE.form.EmployeeForm","isClass":true,"iconCls":"icon-cmp","cls":"cls","leaf":true}
				]}
				,
                {"id":"pkg-TKE.window","text":"window","iconCls":"icon-pkg","cls":"package","singleClickExpand":true, children:[
                {"href":"output/TKE.window.EmployeeSelectionWindow.html","text":"EmployeeSelectionWindow","id":"TKE.window.EmployeeSelectionWindow","isClass":true,"iconCls":"icon-cmp","cls":"cls","leaf":true}
				]}
				]}
				,
        ...
        Docs.icons = {
			...
			"CompanyMgr.CompanySnapshot":"icon-cmp"
			,
			"CompanyMgr.DepartmentMgr":"icon-cmp"
			,
			"CompanyMgr.EmployeeEditorWindow":"icon-cmp"
			,
			"CompanyMgr.EmployeeMgr":"icon-cmp"
			,
			"CompanyMgr.workspace":"icon-static"
			,
			...
			,
			"TKE.chartpanel.ChartPanelBaseCls":"icon-cmp"
			,
			"TKE.chartpanel.DeptBreakdown":"icon-cmp"
			,
			"TKE.chartpanel.TotalCompany":"icon-cmp"
			,
			"TKE.form.DepartmentMgrForm":"icon-cmp"
			,
			"TKE.form.EmployeeMgrForm":"icon-cmp"
			,
			"TKE.window.EmployeeSelectionWindow":"icon-cmp"
			,
			"Array":"icon-cls"
			,
			"Date":"icon-cls"

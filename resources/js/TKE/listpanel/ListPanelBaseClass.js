...
/**
 * @class TKE.listpanel.ListPanelBaseClass
 * @extends Ext.Panel
...
TKE.listpanel.ListPanelBaseClass = Ext.extend(Ext.Panel, {
    layout  : 'fit',
    initComponent : function() {
        this.items = this.buildListView();
        
        TKE.listpanel.ListPanelBaseClass.superclass.initComponent.call(this);
